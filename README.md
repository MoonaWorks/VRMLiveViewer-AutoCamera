...
- [AutoCamera JSON Specification (English)](docs/AutoCamera_JSON_Spec_EN_v1.2.pdf)(ver1.2) - AutoCamera JSON settings, UI mappings, and rules for combining camera parts
