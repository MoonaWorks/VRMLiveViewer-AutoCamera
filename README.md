...
If this is your first time using the project, start with `docs/Getting_Started_EN.md`.
...
- `docs/Getting_Started_EN.md` - Step-by-step workflow for creating Manual Camera Settings with generative AI
- `docs/AutoCamera_JSON_Spec_EN.pdf` - AutoCamera JSON settings, UI mappings, and rules for combining camera parts
- `samples/full_camera_sample_6660f_160bpm.json` - Example output of generated camera work
...
Documents and sample data independently created by MoonaWorks in this repository are intended to be released under CC0 1.0 Universal. This does not apply to VRM Live Viewer itself, the VRM Live Viewer name or logo, or music, models, motions, choreography, stages, costumes, or other materials created by third parties.
