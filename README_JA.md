...
- [AutoCamera JSON仕様書（日本語）](docs/AutoCamera_JSON_Spec_JA_v1.1.pdf)(ver1.1)- AutoCamera JSONの設定値、UIとの対応、カメラパーツの組み合わせ規則
- [AutoCamera サンプルJSON](samples/full_camera_sample_6660f_160bpm_v1.1.json) - カメラワーク生成のアウトプット例
...
注意事項を確認したら、以下の手順書へ進んでください。

### ▶ [生成AIを用いた手動カメラ設定のはじめかた](docs/Getting_Started_JA.md)
