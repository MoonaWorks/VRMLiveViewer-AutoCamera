...
- [生成AIを用いた手動カメラ設定のはじめかた](docs/) - 手動カメラ設定を生成AIで作成する手順
- [AutoCamera JSON指示書（日本語）](docs/) - AutoCamera JSONの設定値、UIとの対応、カメラパーツの組み合わせ規則
- [AutoCamera サンプルJSON](samples/) - カメラワーク生成のアウトプット例
